...
from .core import RolloutStrategy, send_next_action, send_next_action_chunk
...
class BaseStrategy(RolloutStrategy):
    ...
    def run(self, ctx: RolloutContext) -> None:
        ...
        while not ctx.runtime.shutdown_event.is_set():
            ...
            if engine.produces_chunks:
                action_dict = send_next_action_chunk(obs_processed, obs, ctx)
            else:
